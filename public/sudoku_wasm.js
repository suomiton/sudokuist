 ...
 * @returns {any}
 */
export function analyzePuzzleDifficulty(board) {
    const ret = wasm.analyzePuzzleDifficulty(board);
    return ret;
}
...
export function solveBoard(board) {
    const ret = wasm.solveBoard(board);
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v1;
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_5a86302baf03e83b = function() { return logError(function (arg0, arg1) {
